const manager = new Mangarer();
const detailsArea = new DetailsArea("details", manager);
const studentsArea = new StudentsArea("student-list", manager)
...
for(const elem of array){   //vegigiterulnk az arrayen es minden objektum alapjan peldanyositjuk a ...
